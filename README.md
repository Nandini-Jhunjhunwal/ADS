...
|-----------|-------------|--------------|----------------------------|
| FindPairWithKSum.java | Checks if any pair in array sums to K | Two Pointers / Hashing | 1 – Two Sum, 167 – Two Sum II, 15 – 3Sum, 18 – 4Sum |
| FixedSizeSlidingWindow.java | Finds max/min sum of subarray of size K | Fixed Size Sliding Window | 643 – Maximum Average Subarray I, 1456 – Max Vowels, 438 – Find All Anagrams |
| MaxSubArray.java | Finds maximum sum contiguous subarray | Kadane’s Algorithm | 53 – Maximum Subarray, 152 – Maximum Product Subarray, 918 – Max Circular Subarray |
